...
(3, 1, 2, '75.00', '78.00', 3, '2019-11-11 03:06:09', 1),
(4, 1, 4, '35.00', '78.00', 3, '2019-11-11 03:06:09', 1);
...
CREATE TABLE `billing_addresses` (
  `bla_id` bigint UNSIGNED NOT NULL,
  `bla_user_id` bigint UNSIGNED NOT NULL,
  `bla_country_id` smallint UNSIGNED NOT NULL,
  ...
  `bla_surname` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `bla_name` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
...
CREATE TABLE `continents` (
  `con_id` tinyint UNSIGNED NOT NULL,
...
CREATE TABLE `countries` (
  `ctr_id` smallint UNSIGNED NOT NULL,
  `ctr_title` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ctr_code` varchar(2) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `ctr_continent_id` tinyint UNSIGNED NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `currencies` (
  `cur_id` tinyint UNSIGNED NOT NULL,
...
CREATE TABLE `custom_products_filters_values` (
  `csp_id` int UNSIGNED NOT NULL,
  `csp_selling_id` int UNSIGNED NOT NULL,
  `csp_filter_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `listings` (
  `lis_id` bigint UNSIGNED NOT NULL,
  `lis_selling_id` int UNSIGNED NOT NULL,
  `lis_price` decimal(10,2) UNSIGNED NOT NULL,
  `lis_currency_id` tinyint UNSIGNED NOT NULL COMMENT 'shipping costs are based on this value',
  `lis_fee_eur` decimal(10,2) NOT NULL,
  `lis_from` date NOT NULL,
  `lis_to` date NOT NULL,
  `lis_watching` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `lis_is_auction` tinyint UNSIGNED NOT NULL DEFAULT '0',
  `lis_bought` tinyint NOT NULL DEFAULT '0',
  `lis_active` tinyint UNSIGNED NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `listings` (`lis_id`, `lis_selling_id`, `lis_price`, `lis_currency_id`, `lis_fee_eur`, `lis_from`, `lis_to`, `lis_watching`, `lis_is_auction`, `lis_bought`, `lis_active`) VALUES
(1, 2, '45.00', 1, '1.00', '2020-07-01', '2020-08-01', 0, 0, 0, 1),
(2, 3, '1.45', 1, '1.00', '2020-07-01', '2020-08-01', 0, 0, 0, 1),
(3, 8, '45.00', 2, '0.00', '2020-07-01', '2020-08-01', 0, 0, 0, 1),
(4, 9, '35.00', 1, '0.23', '2020-07-01', '2020-08-01', 0, 1, 0, 1);
...
CREATE TABLE `listing_watching` (
  `lwi_id` int UNSIGNED NOT NULL,
  `lwi_user_ud` bigint UNSIGNED NOT NULL,
  `lwi_listing_id` bigint UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `orders` (
  ...
  `ord_shipaddress_id` bigint UNSIGNED NOT NULL,
  `ord_billaddress_id` bigint UNSIGNED NOT NULL,
  `ord_paymethod_id` tinyint UNSIGNED NOT NULL,
  `ord_bank_transaction_id` varchar(45) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `ord_currency_id` tinyint UNSIGNED NOT NULL,
  `ord_created` datetime NOT NULL,
  `ord_success` tinyint UNSIGNED NOT NULL DEFAULT '0',
...
CREATE TABLE `order_items` (
  ...
  `itm_order_id` bigint UNSIGNED NOT NULL,
  `itm_product_id` int UNSIGNED NOT NULL,
  `itm_seller_id` int UNSIGNED NOT NULL,
  `itm_quantity` tinyint UNSIGNED NOT NULL,
  `itm_tracking_nums` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  ...
  `itm_currency_id` tinyint UNSIGNED NOT NULL,
  `itm_status_id` tinyint UNSIGNED NOT NULL,
  `itm_void` tinyint UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `order_item_track_history` (
  `itmh_id` bigint UNSIGNED NOT NULL,
  `itmh_item_id` bigint UNSIGNED NOT NULL,
  `itmh_status_id` tinyint UNSIGNED NOT NULL,
...
CREATE TABLE `order_statuses` (
  ...
  `stat_title` varchar(34) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `paymethods` (
  `pm_id` tinyint UNSIGNED NOT NULL,
  `pm_title` varchar(25) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `products` (
  ...
  `prod_category_id` mediumint UNSIGNED NOT NULL DEFAULT '1',
  `prod_preowned` tinyint UNSIGNED NOT NULL DEFAULT '0'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE `products_filters` (
  ...
  `fil_product_category` mediumint UNSIGNED NOT NULL,
  `fil_filterable` tinyint NOT NULL DEFAULT '1'
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
INSERT INTO `products_filters` (`fil_id`, `fil_title`, `fil_product_category`, `fil_filterable`) VALUES
(1, 'Cover', 2, 1),
(2, 'Unused', 1, 1),
(3, 'Language', 2, 1),
(4, 'Publication Year', 2, 1),
(5, 'Duration', 4, 1),
(6, 'ISBN', 2, 1),
(7, 'Pages', 2, 1),
(8, 'Dimensions', 2, 1),
...
CREATE TABLE `products_filter_values` (
  `pfv_id` int UNSIGNED NOT NULL,
  `pfv_product_id` int UNSIGNED NOT NULL,
  `pfv_filter_id` int UNSIGNED NOT NULL,
...
CREATE TABLE `reviews` (
  ...
  `rev_usr_id` bigint UNSIGNED NOT NULL,
  `rev_ord_item_id` bigint UNSIGNED NOT NULL,
  `rev_comment` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `sellers` (
  `sel_id` int UNSIGNED NOT NULL,
  `seller_usr_id` bigint UNSIGNED NOT NULL,
  `sel_title` varchar(125) NOT NULL,
  `sel_country_id` smallint UNSIGNED NOT NULL DEFAULT '1',
...
CREATE TABLE `selling` (
  `sll_id` int UNSIGNED NOT NULL,
  `sll_seller_id` int UNSIGNED NOT NULL,
  `sll_product_id` int UNSIGNED NOT NULL,
  `sll_quantity` int UNSIGNED NOT NULL,
...
CREATE TABLE `shipping_addresses` (
  `shp_id` bigint UNSIGNED NOT NULL,
  `shp_user_id` bigint UNSIGNED NOT NULL,
  `shp_country_id` smallint UNSIGNED NOT NULL,
  `shp_city` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_region` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_street` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_street_no` varchar(8) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_code` varchar(9) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_surname` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `shp_name` varchar(55) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
CREATE TABLE `shipping_costs` (
  `shc_id` int UNSIGNED NOT NULL,
  `shc_selling_id` int UNSIGNED NOT NULL,
  `shc_continent_id` tinyint UNSIGNED NOT NULL,
...
CREATE TABLE `shipping_costs_exceptions` (
  `shcx_id` int UNSIGNED NOT NULL,
  `shcx_selling_id` int UNSIGNED NOT NULL,
  `shcx_country_id` smallint UNSIGNED NOT NULL,
...
CREATE TABLE `shipping_country_forbidden` (
  `shf_id` int UNSIGNED NOT NULL,
  `shf_selling_id` int UNSIGNED NOT NULL,
  `shf_country_id` smallint UNSIGNED NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
--
ALTER TABLE `biddings`
  MODIFY `bid_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `billing_addresses`
--
ALTER TABLE `billing_addresses`
  MODIFY `bla_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;

--
-- AUTO_INCREMENT for table `countries`
--
ALTER TABLE `countries`
  MODIFY `ctr_id` smallint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;

--
-- AUTO_INCREMENT for table `currencies`
--
ALTER TABLE `currencies`
  MODIFY `cur_id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `custom_products_filters_values`
--
ALTER TABLE `custom_products_filters_values`
  MODIFY `csp_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `listings`
--
ALTER TABLE `listings`
  MODIFY `lis_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `listing_watching`
--
ALTER TABLE `listing_watching`
  MODIFY `lwi_id` int UNSIGNED NOT NULL AUTO_INCREMENT;

--
-- AUTO_INCREMENT for table `orders`
--
ALTER TABLE `orders`
  MODIFY `ord_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `order_items`
--
ALTER TABLE `order_items`
  MODIFY `itm_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `order_item_track_history`
--
ALTER TABLE `order_item_track_history`
  MODIFY `itmh_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `order_statuses`
--
ALTER TABLE `order_statuses`
  MODIFY `stat_id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `paymethods`
--
ALTER TABLE `paymethods`
  MODIFY `pm_id` tinyint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `products`
--
ALTER TABLE `products`
  MODIFY `prod_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `products_categories`
--
ALTER TABLE `products_categories`
  MODIFY `cat_id` mediumint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;

--
-- AUTO_INCREMENT for table `products_filters`
--
ALTER TABLE `products_filters`
  MODIFY `fil_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=12;

--
-- AUTO_INCREMENT for table `products_filter_values`
--
ALTER TABLE `products_filter_values`
  MODIFY `pfv_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=28;
...
--
ALTER TABLE `sellers`
  MODIFY `sel_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `selling`
--
ALTER TABLE `selling`
  MODIFY `sll_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=10;

--
-- AUTO_INCREMENT for table `shipping_addresses`
--
ALTER TABLE `shipping_addresses`
  MODIFY `shp_id` bigint UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;

--
-- AUTO_INCREMENT for table `shipping_costs`
--
ALTER TABLE `shipping_costs`
  MODIFY `shc_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `shipping_costs_exceptions`
--
ALTER TABLE `shipping_costs_exceptions`
  MODIFY `shcx_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `shipping_country_forbidden`
--
ALTER TABLE `shipping_country_forbidden`
  MODIFY `shf_id` int UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=5;
...
--
ALTER TABLE `order_items`
  ADD CONSTRAINT `FK3cq0cuvtl0boawkdli6asnw51` FOREIGN KEY (`itm_product_id`) REFERENCES `products` (`prod_id`),
