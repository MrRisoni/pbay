...
--
-- Host: 127.0.0.1
-- Generation Time: Nov 26, 2019 at 01:55 PM
...
(3, 8, '45.00', 2, '0.00', '2019-11-01', '2019-11-30', 0);
...
--
ALTER TABLE `products_filters`
    MODIFY `fil_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=9;

--
-- AUTO_INCREMENT for table `products_filter_values`
--
ALTER TABLE `products_filter_values`
    MODIFY `pfv_id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=7;
